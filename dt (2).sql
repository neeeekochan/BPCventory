...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2022 at 07:59 PM
...
(50001, 40001, 20, '2022-12-14 00:00:00', 'incomplete');
...
(40001, 'SUB ASSY BODY WITH LOCKPIN', '62 7289*3801*30', 'Small', '25MM', '36x30x30 ', 565, 330, 235, 945, 0, 0),
(40002, 'SUB ASSY BODY WITH LOCKPIN', '504 7287*1915*90', 'Small', '22MM', '30x30x30 ', 565, 330, 235, 966, 0, 0),
(40003, 'SUB ASSY BODY WITH LOCK PIN', '506 7289*1915*30\r\n', 'Small', '23MM', '30x30x30', 565, 330, 235, 944, 0, 0),
...
(100281, '2023-01-20 07:38:13', 00000000004, 10002),
...
(100319, '2022-12-14 06:37:37', 00000000003, 10001),
(100320, '2022-12-17 17:46:42', 00000000003, 10003),
(100321, '2022-12-17 18:42:46', 00000000003, 10007),
(100322, '2022-12-17 18:43:31', 00000000003, 10002);
...
(11400, 100319, 40001, 500, 282500),
(11401, 100320, 40002, 34, 19210),
(11402, 100321, 40003, 56, 31640),
(11403, 100322, 40001, 55, 31075);
...
--
ALTER TABLE `make`
  MODIFY `production_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50003;
...
--
ALTER TABLE `products`
  MODIFY `product_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40009;

--
-- AUTO_INCREMENT for table `sales`
--
ALTER TABLE `sales`
  MODIFY `sales_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100323;

--
-- AUTO_INCREMENT for table `sales_details`
--
ALTER TABLE `sales_details`
  MODIFY `sale_details_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11404;
